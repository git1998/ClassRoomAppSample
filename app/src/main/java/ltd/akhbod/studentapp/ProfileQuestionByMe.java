...
public class ProfileQuestionByMe extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
         mView=inflater.inflate(R.layout.profile_question_byme,container,false);
        ...
        recyclerView = mView.findViewById(R.id.profile_question_byme_recyclerView);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<AllQuestionsDetails, ProfileQuestionSaved.PostViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<AllQuestionsDetails, ProfileQuestionSaved.PostViewHolder>(
            ...
            protected void populateViewHolder(final ProfileQuestionSaved.PostViewHolder viewHolder, final AllQuestionsDetails model, int position) {
                ...
                if (model.getByme().equals(Auth.getCurrentUser().getUid().toString())) {
                    ...
                    viewHolder.mSattred.setVisibility(View.INVISIBLE);
                }
                else
                {
